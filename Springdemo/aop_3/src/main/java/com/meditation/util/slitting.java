...
public class slitting {
     ...
     * 抽取可重复的切入点表达式
     */
    @Pointcut(value = "execution(public int com.meditation.service.impl.Calculatorimpl.*(int,int))")
    ...
    @AfterReturning(value = "myexecution()", returning =
            "result")
     ...
     * 普通通知返回 或 异常通知;
     */
    @Around("execution(public int com.meditation.service.impl.Calculatorimpl.*(int,int))")
